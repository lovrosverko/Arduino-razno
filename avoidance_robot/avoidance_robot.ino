...
#define TRIG_PIN 19 // Pin A4 on the Motor Drive Shield connected to the ultrasonic sensor
#define ECHO_PIN 17 // Pin A5 on the Motor Drive Shield connected to the ultrasonic sensor
...
AF_DCMotor rightMotor(4, MOTOR12_1KHZ); // create motor #2, using M2 output, set to 1kHz PWM frequency
